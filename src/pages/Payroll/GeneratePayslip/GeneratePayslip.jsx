...
const useremail = customerData?.useremail || '';
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/add_generate_payslip', formData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (month && selectedEmployee) {
            ...
            axios.post('https://office3i.com/api/public/api/get_emp_yearmonth_details', {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (month && selectedEmployee && lossOfPay) {
            ...
            axios.post('https://office3i.com/api/public/api/ot_emp_salary_details', {
                emp_id: selectedEmployee,
                yearmonth: yearMonth,
                lop: lossOfPay,
            }, {
