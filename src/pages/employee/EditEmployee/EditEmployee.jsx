...
const officialuseremail = customerData?.officialuseremail || '';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://office3i.com/api/public/api/employee_detailslitshow/${id}`, {
          headers: {
        ...
        if (data && data.employee_details) {
          ...
          setImagePreviewUrl(`https://office3i.com/api/storage/app/${data.employee_details.profile_img}`);
        ...
        if (data && data.employee_documents && data.employee_documents.length > 0) {
          const documents = data.employee_documents.map(doc => ({
            ...
            // selectedFile: `https://office3i.com/api/storage/app/${doc.document_img}`,
          ...
          setFilePreviews(data.employee_documents.map(doc => `https://office3i.com/api/storage/app/${doc.document_img}`));
  ...
  // useEffect(() => {
  //   setImagePreviewUrl(`https://office3i.com/api/storage/app/${formData.employeePicture}`);
  ...
  const handleUpdateDocument = async (index) => {
    ...
    try {
      const response = await axios.post('https://office3i.com/api/public/api/update_employee_document', formData, {
        headers: {
          'Authorization': `Bearer ${usertoken}`,
          'Registered-Email': officialuseremail,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://office3i.com/api/public/api/update_employee_details', {
        method: 'POST',
        body: formDataToSend,
        headers: {
          'Authorization': `Bearer ${usertoken}`,
  ...
  //     try {
  //       const response = await axios.get('https://office3i.com/api/public/api/employee_uid', {
  //         headers: {
  //           'Authorization': `Bearer ${usertoken}`,
  // 'Registered-Email': officialuseremail
  //         }
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://office3i.com/api/public/api/supervisor_list/${formData.selectedRoleId}`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`,
            'Registered-Email': officialuseremail
          }
  ...
  //   const fetchUserRoleDropdown = async () => {
  //     try {
  //       const response = await axios.get(`https://office3i.com/api/public/api/shiftslotlist`, {
  //         headers: {
  //           'Authorization': `Bearer ${usertoken}`,
  // 'Registered-Email': officialuseremail
  //         }
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://office3i.com/api/public/api/employee_document_typelist`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`,
            'Registered-Email': officialuseremail
          }
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://office3i.com/api/public/api/employee_categorylist`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`,
            'Registered-Email': officialuseremail
          }
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://office3i.com/api/public/api/getjobtype`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`,
            'Registered-Email': officialuseremail
          }
