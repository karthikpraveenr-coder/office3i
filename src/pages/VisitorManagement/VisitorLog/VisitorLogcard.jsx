...
const useremail = customerData?.useremail || '';
    ...
    const handlecheckout = (e) => {
        ...
        axios.put('https://office3i.com/api/public/api/visitor_checkout', requestData, {
            headers: {
        ...
        <Container style={{ padding: '20px 30px 0px 30px', display: 'flex', justifyContent: 'center' }} className='mb-5'>
            ...
            <div className='visitorlog__container'>
                ...
                <div className='visitorlog__header'>
                    ...
                    <img src={`https://office3i.com/api/storage/app/${profile_img}`} alt='Visitor_profile' className='Visitor_profile' />
