...
'Registered-Email': officialuseremail
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/employeeshiftinsert', requestData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_employeeshift', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_employeeshift', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
