...
const useremail = customerData?.useremail || '';
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/attendancetypeinsert', requestData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_attendancetype', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_attendancetype', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
