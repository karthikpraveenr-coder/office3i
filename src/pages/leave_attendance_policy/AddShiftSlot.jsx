...
const useremail = customerData?.useremail || '';
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/shiftslotinsert', requestData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_shiftslot', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_shiftslot', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
