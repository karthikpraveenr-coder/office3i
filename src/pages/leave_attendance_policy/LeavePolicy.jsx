...
const useremail = customerData?.useremail || '';
    ...
    useEffect(() => {
        ...
        axios.get('https://office3i.com/api/public/api/leave_type_list', {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        const apiUrl = `https://office3i.com/api/public/api/employee_dropdown_list/${formattedSelectedRole}`;
...
'Registered-Email': officialuseremail
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/addleave_policy', requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_leavepolicy', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_leavepolicy', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
