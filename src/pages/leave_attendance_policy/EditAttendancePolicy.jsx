...
const useremail = customerData?.useremail || '';
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://office3i.com/api/public/api/update_attendancepolicy', requestData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/editview_attendancepolicy/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
