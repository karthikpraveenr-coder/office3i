...
const officialuseremail = customerData?.officialuseremail || '';
  ...
  useEffect(() => {
    // Fetch request types
    fetch('https://office3i.com/api/public/api/attendance_type_list', {
      headers: {
  ...
  useEffect(() => {
    // Fetch locations
    fetch('https://office3i.com/api/public/api/attendance_location_list', {
      headers: {
        'Authorization': `Bearer ${usertoken}`,
        'Registered-Email': officialuseremail
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://office3i.com/api/public/api/add_employee_attendance_request', {
        method: 'POST',
        body: formDataToSend,
        headers: {
          'Authorization': `Bearer ${usertoken}`,
  ...
  const handleLeaveSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://office3i.com/api/public/api/add_employee_leave_request', {
        method: 'POST',
        body: formDataToSend,
        headers: {
          'Authorization': `Bearer ${usertoken}`,
  ...
  const handleSubmitOverTime = async (e) => {
    ...
    try {
      const response = await fetch('https://office3i.com/api/public/api/add_employee_ot_request', {
        method: 'POST',
        body: formDataToSend,
        headers: {
          'Authorization': `Bearer ${usertoken}`,
