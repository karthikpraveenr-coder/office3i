...
function InvoiceList() {
    ...
    const GoToViewPage = (id) => {
        navigate(`/admin/invoicelistview/${id}`);
    };
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/proforma_invoice_list', {
                method: 'POST',
                headers: {
    ...
    const handleExportPDF = () => {
        ...
        doc.autoTable({
            head: [['S.No', 'Invoice Number', 'Name', 'Email', 'Plan Name', 'Addon Employee Count', 'Plan Type', 'Payment Method', 'Payment Status', 'Start Date', 'End Date']],
            body: data,
        ...
        <>
            ...
            {loading ? (
                ...
                <Container fluid className='shift__container'>
                    <h3 className='mb-5' style={{ fontWeight: 'bold', color: '#00275c' }}>Invoice List</h3>
