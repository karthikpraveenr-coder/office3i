...
const officialuseremail = customerData?.officialuseremail || '';
    ...
    // ------------------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get('https://office3i.com/api/public/api/country_list', {
            headers: {
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://office3i.com/api/public/api/state_list/${selectedCountry.value || selectedCountry}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
                    'Registered-Email': officialuseremail
                }
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://office3i.com/api/public/api/city_list/${selectedState.value || selectedState}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
                    'Registered-Email': officialuseremail
                }
    ...
    useEffect(() => {
        ...
        const fetchCities = async () => {
            try {
                const response = await axios.get('https://office3i.com/api/public/api/all_city_list', {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`,
                        'Registered-Email': officialuseremail
                    }
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/editpresale_leadlist', formData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
                'Registered-Email': officialuseremail
            }
    ...
    //         try {
    //             const response = await axios.get('https://office3i.com/api/public/api/getautogenerateLeadId', {
    //                 headers: {
    //                     'Content-Type': 'application/json',
    //                     'Authorization': `Bearer ${usertoken}`,
    // 'Registered-Email': officialuseremail 
    // Assuming usertoken is defined somewhere
    //                 },
    //             });
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/viewedit_leadlist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
                'Registered-Email': officialuseremail
            }
                            ...
                            <Form.Group controlId="preferredLocation">
                                {consultDocument !== '-' && (
                                    <>
                                        ...
                                        <button style={{}} className="btn-view" onClick={() => { window.open(`https://office3i.com/api/storage/app/${consultDocument}`, '_blank') }}>
