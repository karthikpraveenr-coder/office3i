...
function EditTemplate() {
    ...
    // useEffect(() => {
    //     if (file) {
    //         document.querySelector("#img").setAttribute("src", `https://office3i.com/api/storage/app/${file}`);
    //     }
    // }, [file]);
    ...
    //     axios.post(`https://office3i.com/api/public/api/hr_template_update`, formData, {
    //         headers: {
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/hr_edit_templatelist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
                'Registered-Email': officialuseremail
            }
                            ...
                            <Col sm={6} md={6} lg={6} xl={6}>
                                <Form.Group controlId="formFile">
                                    ...
                                    {file && file.endsWith('.pdf') ? (
                                        ...
                                        <a id="fileLink" href={`https://office3i.com/api/storage/app/${file}`} target="_blank" rel="noopener noreferrer">
                                            View Current PDF
                                        </a>
                                    ) : (
                                        <img id="img" src={file ? `https://office3i.com/api/storage/app/${file}` : ''} alt="file" style={{ height: '150px' }} />
                                    )}
