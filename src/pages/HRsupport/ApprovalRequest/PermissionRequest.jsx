...
const useremail = customerData?.useremail || '';
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://office3i.com/api/public/api/approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/hr_permission_approvallist', {
                                    ...
                                    filteredleaveData.map((row, index) => {
                                        ...
                                        return (
                                            <tr key={row.id}>
                                                ...
                                                <td>{row.proof !== null ?
                                                    <button className="btn-view" onClick={() => { window.open(`https://office3i.com/api/storage/app/${row.proof}`, '_blank') }}>
