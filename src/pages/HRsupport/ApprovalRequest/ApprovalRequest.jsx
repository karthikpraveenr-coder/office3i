...
export default function ApprovalRequest() {
    ...
    useEffect(() => {
        if (selectedDepartment) {
            const fetchMembers = async () => {
                try {
                    const response = await axios.get(`https://office3i.com/api/public/api/employee_dropdown_list/${selectedDepartment}`, {
                        headers: {
                            'Authorization': `Bearer ${usertoken}`,
                            'Registered-Email': officialuseremail
                        }
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/leave_category_list';
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/leave_type_list';
        const fetchData = async () => {
            try {
                const response = await axios.get(apiUrl, {
                    headers: {
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/attendance_type_list';
        const fetchData = async () => {
            try {
                const response = await axios.get(apiUrl, {
                    headers: {
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/attendance_location_list';
        const fetchData = async () => {
            try {
                const response = await axios.get(apiUrl, {
                    headers: {
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/shiftslotlist';
        const fetchData = async () => {
            try {
                const response = await axios.get(apiUrl, {
                    headers: {
    ...
    useEffect(() => {
        const apiUrl = 'https://office3i.com/api/public/api/overtime_type_list';
        const fetchData = async () => {
            try {
                const response = await axios.get(apiUrl, {
                    headers: {
    ...
    const submitData = async () => {
        ...
        formData.append('hr_id', customerData.userempid);
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/add_menualentry', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
    ...
    const handleSubmitAttendance = async (e) => {
        ...
        formDataToSend.append('hr_id', customerData.userempid);
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/add_attendancemenualentry', {
                method: 'POST',
                body: formDataToSend,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
    ...
    const handleSubmitOverTime = async (e) => {
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/add_otmenualentry', {
                method: 'POST',
                body: formDataToSend,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
    ...
    const checkShiftSlot = async () => {
        if (toDate || toTime) {
            try {
                const response = await fetch('https://office3i.com/api/public/api/shift_slot_checking', {
                    method: 'POST',
                    headers: {
