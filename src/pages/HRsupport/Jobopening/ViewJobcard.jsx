...
const useremail = customerData?.useremail || '';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://office3i.com/api/public/api/edit_jobopening_list/${id}`, {
                    headers: {
...
'Registered-Email': officialuseremail
    ...
    const handleDelete = async () => {
        try {
            ...
            if (reason) {
                const response = await axios.post('https://office3i.com/api/public/api/delete_job_opening', {
                    id: id,
