...
'Registered-Email': officialuseremail
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://office3i.com/api/public/api/update_company_information`, requestData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/editview_company_information/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
