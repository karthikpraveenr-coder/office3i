...
const officialuseremail = customerData?.officialuseremail || '';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/addpurchaseinvoice', {
                method: 'POST',
                headers: {
    ...
    //         fetch(`https://office3i.com/api/public/api/sales_hsn_sac/${descriptionalGoods.value}`, {
    //             headers: {
    //                 'Authorization': `Bearer ${usertoken}`,
    // 'Registered-Email': officialuseremail
    //             }
    ...
    useEffect(() => {
        items.forEach((item, index) => {
            if (item.descriptionalGoods) {
                fetch(`https://office3i.com/api/public/api/sales_hsn_sac/${item.descriptionalGoods.value}`, {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`,
                        'Registered-Email': officialuseremail
                    }
