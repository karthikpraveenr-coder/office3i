...
const useremail = customerData?.useremail || '';
    ...
    const fetchTableData = async () => {
        ...
        const apiUrl = `https://office3i.com/api/public/api/view_meeting_list`;
        try {
            const response = await axios.post(apiUrl,
                {
                    emp_id: customerData.userempid,
                    user_roleid: customerData.userrole,
...
'Registered-Email': officialuseremail
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_meeting', {
                    method: 'POST',
                    headers: {
...
'Registered-Email': officialuseremail // Assuming usertoken is defined somewhere
    ...
    const handleActionAcceptandReject = async () => {
        try {
            ...
            formData.append('meetingemp_id', customerData.userempid);
            formData.append('meeting_status', approvalType);
            formData.append('meeting_remarks', reason);

            const response = await fetch('https://office3i.com/api/public/api/approval_meeting', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
    ...
    const handleShow = async (item, status) => {
        ...
        try {
            ...
            const response = await axios.get(`https://office3i.com/api/public/api/meeting_status_list/${item.id}/${status}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
