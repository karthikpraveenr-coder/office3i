...
const useremail = customerData?.useremail || '';
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://office3i.com/api/public/api/tl_approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/tl_permissionrequest_list', {
