...
const useremail = customerData?.useremail || '';
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://office3i.com/api/public/api/tl_approval_halfday_request', {
            method: 'POST',
            body: formData,
            headers: {
...
'Registered-Email': officialuseremail
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://office3i.com/api/public/api/tl_halfdayrequest_list', {
                method: 'POST',
                headers: {
