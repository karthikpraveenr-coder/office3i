...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (eventImage) {
            document.querySelector("#img").setAttribute("src", `https://office3i.com/api/storage/app/${eventImage}`);
        }
    }, [eventImage]);
    ...
    const handleSave = async (e) => {
        ...
        formData.append('updated_by', customerData.userempid);
        ...
        try {
            const response = await fetch('https://office3i.com/api/public/api/update_event', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/view_editevent/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
