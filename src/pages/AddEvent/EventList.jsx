...
const useremail = customerData?.useremail || '';
    ...
    const fetchTableData = async () => {
        ...
        const apiUrl = `https://office3i.com/api/public/api/view_event_list`;
        try {
...
'Registered-Email': officialuseremail
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_event', {
                    method: 'POST',
                    headers: {
...
'Registered-Email': officialuseremail // Assuming usertoken is defined somewhere
    ...
    const handleActionAcceptandReject = async () => {
        try {
            ...
            formData.append('eventemp_id', customerData.userempid);
            formData.append('event_status', approvalType);
            formData.append('event_reason', reason);

            const response = await fetch('https://office3i.com/api/public/api/approval_event', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
    ...
    const handleShow = async (item, status) => {
        ...
        try {
            ...
            const response = await axios.get(`https://office3i.com/api/public/api/event_status_list/${item.id}/${status}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
