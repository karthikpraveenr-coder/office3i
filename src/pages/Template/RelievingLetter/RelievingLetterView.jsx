                ...
                <div className="a4-container">
                    <div ref={pdfContainerRef} className="content">
                        <div className="d-flex justify-content-between align-items-center mb-5 header">
                            <img src={`https://office3i.com/api/storage/app/${relievingletter.header_attachment}`} alt="Stark Industries Logo" className="logo" />
                        </div>
                        ...
                        <div className="footer text-center">
                            ...
                            <img src={`https://office3i.com/api/storage/app/${relievingletter.footer_attached}`} alt="Offerletter_Footer" className="logo" />
                        </div>
