...
const useremail = customerData?.useremail || '';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://office3i.com/api/public/api/update_appointment_letter', formData, {
                headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/edit_appointment_list/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    useEffect(() => {
        if (headerAttachment && headerAttachment instanceof File) {
            ...
            setImagePreviewUrl(`https://office3i.com/api/storage/app/${headerAttachment}`);
        }
    ...
    useEffect(() => {
        if (footerAttachment && footerAttachment instanceof File) {
            ...
            setFooterImagePreviewUrl(`https://office3i.com/api/storage/app/${footerAttachment}`);
        }
        // Cleanup URL when component unmounts or file changes
        return () => {
