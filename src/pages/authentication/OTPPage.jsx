...
const OTPPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://office3i.com/api/public/api/forgot_otp_verifiy', {
                email: userEmail,
                otp: fullOtp
            });
    ...
    const resendOtp = async (e) => {
        ...
        if (!validateEmail(email)) {
            ...
            try {
                const response = await fetch('https://office3i.com/api/public/api/forgot_password', {
                    method: 'POST',
                    headers: {
