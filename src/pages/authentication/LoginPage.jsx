...
const Loginpage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const apiUrl = `https://office3i.com/api/public/api/login`;
          ...
          <Form className="login-form">
            ...
            <Row className="justify-content-md-center Cookie_Policy">
              <Col md="auto" className="footer-links">
                <a href="#" className="footer-link" >Cookie Policy</a> | <Link to="/termsandcondition" className="footer-link">Terms of Use</Link> | <Link to="/privacypolicy"  className="footer-link">Privacy Policy</Link>
              </Col>
            </Row>
