...
const useremail = customerData?.useremail || '';
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://office3i.com/api/public/api/view_announcement', {
                headers: {
...
'Registered-Email': officialuseremail
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/delete_announcement', {
                    method: 'POST',
                    headers: {
...
'Registered-Email': officialuseremail // Assuming usertoken is defined somewhere
    ...
    const handleedit = async (id) => {
        ...
        axios.get(`https://office3i.com/api/public/api/editview_announcement/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://office3i.com/api/public/api/update_announcement`, requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
