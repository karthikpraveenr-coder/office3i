...
const officialuseremail = customerData?.officialuseremail || '';
  ...
  const userCheckInCheckOutCount = async () => {
    ...
    try {
      const response = await fetch('https://office3i.com/api/public/api/employeeIndexinouttime', {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://office3i.com/api/public/api/addmoodboard', requestData, {
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${usertoken}`,
        'Registered-Email': officialuseremail
  ...
  const fetchDatamood = async () => {
    try {
      const response = await fetch(`https://office3i.com/api/public/api/editview_moodboard/${userempid}`, {
        headers: {
          'Authorization': `Bearer ${usertoken}`,
          'Registered-Email': officialuseremail
        }
  ...
  const handleCheckIn = () => {
    ...
    fetch('https://office3i.com/api/public/api/insertwebcheckin', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${usertoken}`,
  ...
  const handleCheckOut = () => {
    ...
    fetch('https://office3i.com/api/public/api/insertcheckout', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${usertoken}`,
        ...
        <Col sm={8}>
          <Row>
            <Col sm={12} className='mb-5 checkin__checkout__container'>
              <Button className='checkin-btn' onClick={handleCheckIn} disabled={checkintime !== '00:00:00' && checkintime !== checkintime} >
                {loadingcheckin ? (
