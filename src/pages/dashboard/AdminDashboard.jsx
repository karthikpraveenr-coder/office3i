...
const DashboardPage = () => {
    ...
    const handleAddAnnouncement = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/addannouncement', requestData, {
            headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_announcement', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
                    'Registered-Email': officialuseremail
                }
    ...
    const fetchmoodboardData = async () => {
        try {
            const response = await fetch('https://office3i.com/api/public/api/view_moodboard', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
                    'Registered-Email': officialuseremail
                }
                    ...
                    <div className='mb-3 Employee__mood__board'>
                        ...
                        <div className='mood__reactions mb-4'>
                            <Row className='mb-3' style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <Col>
                                    <span><img src={happy} alt="happy" className='emoji-icon' /></span>
                                </Col>

                                <Col>
                                    <span><img src={happy_positive} alt="happy_positive" className='emoji-icon' /></span>
                                </Col>

                                <Col>
                                    <span><img src={love_happy} alt="love_happy" className='emoji-icon' /></span>
                                </Col>

                                <Col>
                                    <span><img src={sad_smiley} alt="sad_smiley" className='emoji-icon' /></span>
                                </Col>
                                    ...
                                    <Col sm={12} md={12} lg={12} xl={12} className='mb-3 Reacted__emoji__popup'>
                                        {moodboardlist.map(item => (
                                            <p className='reacted__name__emoji__popup mb-3'>
                                                ...
                                                <img src={`https://office3i.com/api/storage/app/${item.profile_img}`} alt='' className='profile__popup' />
