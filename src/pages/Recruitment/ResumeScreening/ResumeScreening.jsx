...
const useremail = customerData?.useremail || '';
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://office3i.com/api/public/api/career_inboxdetails', {
                method: 'GET',
                headers: {
...
'Registered-Email': officialuseremail,
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://office3i.com/api/public/api/single_delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
    ...
    const BulkhandleDelete = async () => {
        try {
            ...
            if (reason) {
                ...
                const response = await fetch('https://office3i.com/api/public/api/bulk_delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`,
    ...
    const Markasread = async (id) => {
        try {
            const response = await axios.post(
                'https://office3i.com/api/public/api/read_countupdate',
                {
                    id: id,
                    updated_by: userempid
                },
...
'Registered-Email': officialuseremail
    ...
    const Markasunread = async (id) => {
        try {
            const response = await axios.post(
                'https://office3i.com/api/public/api/un_read_countupdate',
                {
                    id: id,
                    updated_by: userempid
                },
...
'Registered-Email': officialuseremail
    ...
    const BulkMarkasread = async () => {
        try {
            const response = await axios.post(
                'https://office3i.com/api/public/api/bulk_read_countupdate',
                {
                    id: selectedIds.join(','),
                    updated_by: userempid
                },
...
'Registered-Email': officialuseremail
    ...
    const BulkMarkasunread = async () => {
        try {
            const response = await axios.post(
                'https://office3i.com/api/public/api/bulk_unread_countupdate',
                {
                    id: selectedIds.join(','),
                    updated_by: userempid
                },
                                            ...
                                            <tr key={row.id} style={
                                                ...
                                                <td>{row.attachment !== null ?
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            const url = `https://office3i.com/api/storage/app/${row.attachment}`;
