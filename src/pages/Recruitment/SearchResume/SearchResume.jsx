...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://office3i.com/api/public/api/state_list/${selectedCountry.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://office3i.com/api/public/api/city_list/${selectedState.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (functionalArea) {
            fetch(`https://office3i.com/api/public/api/area_specialization_list/${functionalArea.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
...
'Registered-Email': officialuseremail
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        const anyFilterFilled = designation || selectedCountry || selectedState || selectedCity || selectedPreferredLocation.length > 0 || functionalArea || areaOfSpecialization || industry || salaryMin || salaryMax || experienceMin || experienceMax;
        ...
        axios.post('https://office3i.com/api/public/api/search_resume_list', formData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
