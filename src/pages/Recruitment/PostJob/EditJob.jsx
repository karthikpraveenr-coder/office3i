...
const useremail = customerData?.useremail || '';
    ...
    useEffect(() => {
        const fetchJobDetails = async () => {
            try {
                const response = await axios.get(`https://office3i.com/api/public/api/post_job_editlist/${id}`, {
                    headers: {
...
'Registered-Email': officialuseremail
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://office3i.com/api/public/api/update_post_job', postData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
