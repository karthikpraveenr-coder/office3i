...
const useremail = customerData?.useremail || '';
    ...
    const handleSave = (e) => {
        ...
        axios.post('https://office3i.com/api/public/api/update_hr_resume', formData, {
            headers: {
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        ...
        fetch('https://office3i.com/api/public/api/ug_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    useEffect(() => {
        ...
        fetch('https://office3i.com/api/public/api/pg_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    useEffect(() => {
        ...
        fetch('https://office3i.com/api/public/api/industry_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    useEffect(() => {
        fetch('https://office3i.com/api/public/api/functional_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
    ...
    useEffect(() => {
        if (functionalArea) {
            fetch(`https://office3i.com/api/public/api/area_specialization_list/${functionalArea.value || functionalArea}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
                }
...
'Registered-Email': officialuseremail
    ...
    useEffect(() => {
        if (attachment) {
            setImagePreviewUrl(`https://office3i.com/api/storage/app/${attachment}`);
    ...
    useEffect(() => {
        axios.get(`https://office3i.com/api/public/api/resume_edit_list/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`,
'Registered-Email': officialuseremail
            }
