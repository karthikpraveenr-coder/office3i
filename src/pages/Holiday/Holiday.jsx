...
const useremail = customerData?.useremail || '';
  ...
  const fetchHolidayData = async () => {
    try {
      const response = await axios.get(`https://office3i.com/api/public/api/viewholidaylist`, {
        headers: {
...
'Registered-Email': officialuseremail
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      try {
        const response = await fetch('https://office3i.com/api/public/api/add_holiday', {
          method: 'POST',
          body: formDataToSend,
    ...
    const handleEditSubmit = async (e) => {
      e.preventDefault();
       ...
       setFormErrors({});
        ...
        try {
          const response = await fetch('https://office3i.com/api/public/api/edit_holiday', {
            method: 'PUT',
            headers: {
...
'Registered-Email': officialuseremail,
    ...
    const handleDelete = async (id) => {
      ...
      try {
        ...
        if (reason) {
          const response = await fetch('https://office3i.com/api/public/api/delete_holiday', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${usertoken}`,
