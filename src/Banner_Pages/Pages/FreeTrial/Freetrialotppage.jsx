...
const Freetrialotppage = () => {
    ...
    const { firstName, lastName, email, password, referenceName, referenceEmployeeCode,mobile,companyName } = useContext(FormContext);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://office3i.com/api/public/api/office3i_singup_otpverification', {
                ...
                ref_emp_code: referenceEmployeeCode,
                module_id: "1",
                plan_id: id,
                created_by: "1"
            });
