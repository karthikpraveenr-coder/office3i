...
import './assets/css/OTPPage.css'; // Import the CSS file here
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import Swal from 'sweetalert2';
import { ContactFormContext } from '../context/ContactFormContext';

const OTPPagecontact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://office3i.com/api/public/api/webcontact_otp_verifiy', {
                email: email,
                otp: fullOtp
            });
    ...
    const resendOtp = async (e) => {
        ...
        if (!validateEmail(email)) {
            ...
            try {
                const response = await fetch('https://office3i.com/api/public/api/webcontact_otp_resent', {
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className="OTP__container__contact">
            <Row className="justify-content-center otpcontact-container mt-5 mb-5">
                <Col md="auto">
                    ...
                    <Form>
                        ...
                        <div className="text-center">
                            ...
                            <Button
                                variant="primary"
                                type="submit"
                                className="mt-3 Verify login-button btn-loading"
