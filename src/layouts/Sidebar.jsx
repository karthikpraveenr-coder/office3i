                    ...
                    <div className="nav">
                                    ...
                                    <nav className="sb-sidenav-menu-nested nav">
                                        ...
                                        {hasAccessToLead() && (
                                            <>
                                                ...
                                                <div className="collapse" id="Lead" aria-labelledby="headingThree" data-bs-parent="#Salesmanagement">
                                        ...
                                        {hasAccessToPreSales() && (
                                            <>
                                                ...
                                                <div className="collapse" id="Presales" aria-labelledby="headingThree" data-bs-parent="#Salesmanagement">
                                        ...
                                        {hasAccessToSales() && (
                                            <>
                                                ...
                                                <div className="collapse" id="Sales" aria-labelledby="headingThree" data-bs-parent="#Salesmanagement">
                                                    {checkedNames.SalesManagement?.Sales?.LeadList?.length > 0 && (
                                                        <Link
                                                            to="/admin/salesleadlist"
                                                            className={`nav-link ${location.pathname === '/admin/salesleadlist' ? 'active' : ''}`}
                                                            style={location.pathname === '/admin/salesleadlist' ? activeStyle : {}}
                                                        >
                                                            Lead List
                                                        </Link>
                                                    )}
                        ...
                        <>
                                ...
                                <Link
                                    ...
                                    className={`nav-link ${location.pathname === '/admin/invoicelist' ? 'active' : ''}`}
                                    style={location.pathname === '/admin/invoicelist' ? activeStyle : {}}
                                >
                                    <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>
                                    Invoice List
                                </Link>
                        ...
                        <>
                                ...
                                <Link
                                    to="/admin/upgradeplan"
                                    className={`nav-link ${location.pathname === '/admin/upgradeplan' ? 'active' : ''}`}
                                    style={location.pathname === '/admin/upgradeplan' ? activeStyle : {}}
                                >
                                    <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>
                                    Upgrade Plan
                                </Link>
