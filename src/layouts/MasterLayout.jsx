...
import InvoiceListview from '../pages/InvoiceList/InvoiceListview'
                    ...
                    <main>
                        <Routes>
                           ...
                           {/* --------------------------------------------------------------------------------------------------- */}
                            ...
                            <Route path="/invoicelist" element={<AuthRoute><InvoiceList /></AuthRoute>}/>
                            <Route path="/invoicelistview/:id" element={<AuthRoute><InvoiceListview /></AuthRoute>}/>
                            <Route path="/upgradeplan" element={<AuthRoute><UpgradePlan /></AuthRoute>}/>
