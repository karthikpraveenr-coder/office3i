...
import Enter_OTP from '../../components/assets/images/Enter_OTP.png';
import '../../components/assets/css/OTPPage.css';
...
const Freetrialotppage = () => {
    ...
    const { firstName, setFirstName, lastName, setLastName, email, setEmail } = useContext(FormContext);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://office3i.com/api/public/api/office3i_singup_otpverification', {
                email_id: email,
            ...
            if (data.status === "success") {
                Swal.fire({
                    ...
                    window.location.href = 'https://office3i.com/login'; // Redirect after success
                });
                setLoading(false);
                return;
            }
    ...
    const resendOtp = async (e) => {
        ...
        if (!validateEmail(email)) {
            ...
            try {
                const response = await fetch('https://office3i.com/api/public/api/office3i_singup_resentotp', {
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className="OTP__container">
            <Row className="justify-content-center otp-container mt-5 mb-5">
                <Col md="auto">
...
export default Freetrialotppage;
