...
const Tryitfree = () => {
        ...
        axios.get(`https://office3i.com/api/public/api/webproduct_list`)
            .then(response => {
                if (Array.isArray(response.data.data)) {
                    ...
                    console.log("setProducts:", sortedProducts)
                } else {
    ...
    const handleSubmit = (e) => {
        ...
        if (!selectedModule) {
            errors.selectedModule = 'Module is required.';
        }
        if (!termsChecked) {
                    ...
                    <Carousel indicators={true}>
                        {products.map((product, index) => (
                            <Carousel.Item key={index}>
                                <div className="text-center col_freetrial col-12 col-md-10 col-lg-8 col-xl-6">
                                        ...
                                        <Card.Body>
                                            ...
                                            <ul className="list-unstyled freetrial_lineheight">
                                                {product.features.map((feature, idx) => (
                                                    <li key={idx}>
                                                        <FontAwesomeIcon icon={faCheck} style={{ color: '#0BC307', marginRight: '5px' }} /> {feature}
                                                    </li>
                                                ))}
                                            </ul>
                                        </Card.Body>
